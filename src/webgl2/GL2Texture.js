...
export class GL2Texture {
    ...
    constructor( target = GL2.TEXTURE_2D, internalformat = GL2.RGBA, width = 0, height = 0, border = 0,
        ...
        TEXTURE_MAG_FILTER = GL2.LINEAR, TEXTURE_MIN_FILTER = GL2.NEAREST_MIPMAP_LINEAR, TEXTURE_WRAP_S = GL2.REPEAT, TEXTURE_WRAP_T = GL2.REPEAT,
    ...
    static updateDataTexture( gl2texture, arrayBufferView, width = gl2texture.width, height = gl2texture.height,
        level = 0, border = gl2texture.border, srcOffset = 0, target = gl2texture.target ) {

        const { internalformat, format, type } = gl2texture;
    ...
    static updateImageTexture( gl2texture, pixels, level = 0, target = gl2texture.target ) {
    ...
    static updateSubDataTexture( gl2texture, data, xoffset, yoffset, width, height, level = 0, srcOffset = 0, target = gl2texture.target ) {

        const { format, type } = gl2texture;
    ...
    static updateSubImageTexture( gl2texture, pixels, xoffset, yoffset, width, height, level = 0, target = gl2texture.target ) {
    ...
    static setParameter( gl2texture, mag = gl2texture.TEXTURE_MAG_FILTER, min = gl2texture.TEXTURE_MIN_FILTER, wrapS = gl2texture.TEXTURE_WRAP_S, wrapT = gl2texture.TEXTURE_WRAP_T ) {
